...
Finally, user-facing category and task pages were prepared. Because these were template-based and in case of the task page relatively complicated, the user interface and server code were implemented in parallel. As a finishing touch a simple home page was added.
